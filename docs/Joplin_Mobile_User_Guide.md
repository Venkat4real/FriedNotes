...
- If you plan to sync notes across devices, go to **Configuration > Synchronization**.

### Configure sync

1. Tap **Synchronization target**.
2. Choose one of the supported sync services: **Dropbox**, **OneDrive**, **Nextcloud**, **WebDAV**, or **File system**.
3. Enter your account or server credentials.
4. Tap **Synchronize** to connect and fetch notes.
...
- Tap the **New note** button in the bottom bar.
- Enter a title and type your content in the editor.
- Notes are saved automatically as you type.

### Use notebooks

- Tap the notebook icon to view notebooks.
- Use **New notebook** to create a notebook for your notes.
- Move notes between notebooks by selecting a note and choosing **Move to notebook**.
...
- The Joplin mobile app supports Markdown formatting.
- Use the toolbar buttons to add bold, italics, headings, lists, and checkboxes.
- You can switch between the editor and preview modes to see formatted output.

### Attachments and images

- Tap **Attach file** or **Insert image** while editing a note.
- Choose images from your gallery or use the camera to capture a new photo.
- Attachments are stored with the note and synced across devices.

### Checklists

- Add tasks using checkbox syntax: `- [ ] Task name`.
...
- Use the search bar at the top of the notes list.
- Search text inside note titles and contents.
- Filter results with tags and notebooks.
...
- Use the desktop app for full import support; mobile is best for note creation and editing.
- If you need to import data directly on mobile, use supported sync services to pull notes from your synced storage.
